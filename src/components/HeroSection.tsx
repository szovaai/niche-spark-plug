  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4 pt-24">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          PDF Empire AI uses the 60-Minute Launch Method to automatically build your product, funnel, bonuses, emails and affiliate kit. Pick a topic. Click build. Launch your product.
        </motion.p>
