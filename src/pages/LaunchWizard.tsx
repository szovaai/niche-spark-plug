...
const LaunchWizard = () => {
  ...
  const generateAll = async () => {
    ...
    try {
      // Step 1
      toast.info("Step 1/5: Generating product concept...");
      ...
      // Step 2
      toast.info("Step 2/5: Generating product content...");
      ...
      // Step 3
      toast.info("Step 3/5: Generating funnel copy...");
      ...
      // Step 4
      toast.info("Step 4/5: Generating marketing assets...");
      ...
      // Step 5
      toast.info("Step 5/5: Generating launch checklist...");
